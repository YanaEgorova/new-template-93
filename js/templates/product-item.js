...
export const item = (product) => {
  ...
  <li class="item swiper-slide" data-aos="fade-up">
    ...
    <a href="product-page.html?id=${product.id}" class="btn btn--first product__link" style="margin: ${product.type == "ring" || product.type == "clothing" ? 'auto' : ''}">details <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
